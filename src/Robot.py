...
#     def sin_curve(self, wave_num):
#         """
#         Moves robot a user-specified amount of whole sinusoidal wavelengths.
#         Contributor: Matthew O'Brien
#         """
#         self._job(self._sin_curve, [wave_num]);
#     def _sin_curve(self, wave_num):
#         for k in (wave_num):
#             self._job(self._move_autonomously, [20, 15, 4], life_span=seconds)
#             self._job(self._move_autonomously, [20, -15, 7], life_span=seconds)
